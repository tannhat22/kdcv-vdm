...
const FooterBlock = ({ isFull }) => {
  ...
  const textColor = theme.palette.mode === 'background.paper';
  ...
  return (
    <>
        ...
        <Box
          ...
          sx={{
            ...
            '&:after': {
              ...
              bottom: 0,
              left: 0,
              background: `linear-gradient(transparent 100%, rgb(31, 31, 31) 70%)`
            }
          }}
        >
          <CardMedia
            component="img"
            image={dashImage(`./img-footer-${config.presetColor}.png`)}
            sx={{
      ...
      <Box
        ...
        sx={{
          py: 1.5,
          bgcolor: theme.palette.mode === theme.palette.grey[800]
        }}
      >
        <Container>
          <Grid container spacing={2}>
